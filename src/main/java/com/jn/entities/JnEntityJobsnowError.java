...
@CcpEntityCache(3600)
// FIXME @CcpEntityAsyncWriter(JnAsyncWriterEntity.class)
//FIXME
//@CcpEntityOperations(
//		operations = {
//				@CcpEntityOperation(when = _after, operation = save, from = mainEntity,  execute = {JnMessages.class}, operationHandlers = {}),
//		},
//		globalHandlers = {}
//		)

//FIXME @CcpEntityDisposable(expurgTime = CcpEntityExpurgableOptions.hourly, expurgableEntityFactory = JnDisposableEntity.class)
