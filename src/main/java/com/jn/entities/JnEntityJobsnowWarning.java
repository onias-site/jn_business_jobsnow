...
import com.jn.business.messages.JnBusinessNotifyWarning;
...
@CcpEntityOperations(
		operations = {
				@CcpEntityOperation(when = _after, operation = save, from = mainEntity,  execute = {JnBusinessNotifyWarning.class}, operationHandlers = {}),
		},
		globalHandlers = {}
		)
