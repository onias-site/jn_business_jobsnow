...
@CcpEntityFieldsValidator(classReferenceWithTheFields = JnEntityUserRequest.Fields.class)
@CcpEntityCache(3600)
public class JnEntityUserRequest implements CcpEntityConfigurator {

	public static final CcpEntity ENTITY = new CcpEntityFactory(JnEntityUserRequest.class).entityInstance;
